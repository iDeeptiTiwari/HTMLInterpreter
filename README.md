...
# How to use!!?
 ...
 - After writing code: click on **RUN** button to get the output. Pressing **RUN** without any code with give you an alert.
 - In order to remove all the code & output, click on **RESET** button.
